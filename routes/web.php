...
//     return view('frontend.pokja-page.sekretariat');
// });

// Route::get('/pokja-i', function () {
//     return view('frontend.pokja-page.pokja1');
// });

// Route::get('/pokja-ii', function () {
//     return view('frontend.pokja-page.pokja2');
// });
// Route::get('/pokja-iii', function () {
//     return view('frontend.pokja-page.pokja3');
// });
// Route::get('/pokja-iv', function () {
//     return view('frontend.pokja-page.pokja4');
// });
// Route::get('/sejarah-pkk', function () {
//     return view('frontend.profile-page.sejarah');
// });
// Route::get('/10-program-pokok', function () {
//     return view('frontend.profile-page.10-program-pkk');
// });

// Route::get('/arti-dan-logo', function () {
//     return view('frontend.profile-page.arti-logo');
// });

// Route::get('/visi-misi', function () {
//     return view('frontend.profile-page.visi-misi');
// });

// Route::get('/struktur-organisasi', function () {
//     return view('frontend.profile-page.struktur-organisasi');
// });
